...
def run_flow(opts, tmpdirname):
    ...
    def process_core(core):
        ...
        if(opts.xchesscc):
          ...
          do_call(['/home/Jinming/research/mlir_aie/llvm-project/build/bin/llvm-link', file_core_llvmir_chesshack, chess_intrinsic_wrapper, '-S', '-o', file_core_llvmir_chesslinked])
    ...
    def process_arm_cgen():
      ...
      cmd += ['-B%s/usr/lib/aarch64-xilinx-linux/10.2.0' % opts.sysroot]
