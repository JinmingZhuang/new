; ModuleID = '/home/Jinming/research/aie_project/n2n/aie/n2n_trans1.cc'
source_filename = "/home/Jinming/research/aie_project/n2n/aie/n2n_trans1.cc"
...
define dso_local void @_Z10n2n_trans1P12input_windowIsEP13output_windowIsE(%struct.input_window* %matA, %struct.output_window* %matB) addrspace(1) #0 !dbg !92 {
entry:
  %matA.addr = alloca %struct.input_window*, align 4
  %matB.addr = alloca %struct.output_window*, align 4
  %i = alloca i32, align 4
  %A = alloca i16, align 2
  store %struct.input_window* %matA, %struct.input_window** %matA.addr, align 4, !tbaa !104
  call addrspace(1) void @llvm.dbg.declare(metadata %struct.input_window** %matA.addr, metadata !97, metadata !DIExpression()), !dbg !108
  store %struct.output_window* %matB, %struct.output_window** %matB.addr, align 4, !tbaa !104
  call addrspace(1) void @llvm.dbg.declare(metadata %struct.output_window** %matB.addr, metadata !98, metadata !DIExpression()), !dbg !109
...
for.body:                                         ; preds = %for.cond
  store i16 undef, i16* %A, align 2, !dbg !118
  %3 = bitcast i16* %A to i8*, !dbg !118
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #8, !dbg !118
  call addrspace(1) void @llvm.dbg.declare(metadata i16* %A, metadata !101, metadata !DIExpression()), !dbg !119
  %4 = load %struct.input_window*, %struct.input_window** %matA.addr, align 4, !dbg !120, !tbaa !104
  ...
  store i16 %call, i16* %A, align 2, !dbg !119, !tbaa !122
  %5 = load %struct.output_window*, %struct.output_window** %matB.addr, align 4, !dbg !124, !tbaa !104
  %6 = load i16, i16* %A, align 2, !dbg !125, !tbaa !122
...
!1 = !DIFile(filename: "/home/Jinming/research/aie_project/n2n/aie/n2n_trans1.cc", directory: "/home/Jinming/research/aie_project/n2n/Work/aie/ir")
!2 = !{!3}
...
!92 = distinct !DISubprogram(name: "n2n_trans1", linkageName: "_Z10n2n_trans1P12input_windowIsEP13output_windowIsE", scope: !93, file: !93, line: 5, type: !94, scopeLine: 6, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !96)
!93 = !DIFile(filename: "aie/n2n_trans1.cc", directory: "/home/Jinming/research/aie_project/n2n")
!94 = !DISubroutineType(types: !95)
!95 = !{null, !20, !71}
!96 = !{!97, !98, !99, !101}
!97 = !DILocalVariable(name: "matA", arg: 1, scope: !92, file: !93, line: 5, type: !20)
!98 = !DILocalVariable(name: "matB", arg: 2, scope: !92, file: !93, line: 6, type: !71)
!99 = !DILocalVariable(name: "i", scope: !100, file: !93, line: 8, type: !5)
!100 = distinct !DILexicalBlock(scope: !92, file: !93, line: 8, column: 3)
!101 = !DILocalVariable(name: "A", scope: !102, file: !93, line: 9, type: !50)
...
!132 = !DILocation(line: 12, column: 1, scope: !92)
