...
entry:
  ...
  store [1 x %struct.window_internal] undef, [1 x %struct.window_internal]* %window_buf0_buf0d, align 4, !dbg !160, !noalias !151
  %0 = bitcast [1 x %struct.window_internal]* %window_buf0_buf0d to i8*, !dbg !160
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 52, i8* %0) #5, !dbg !160, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata [1 x %struct.window_internal]* %window_buf0_buf0d, metadata !125, metadata !DIExpression()), !dbg !161
  %1 = call addrspace(1) i8* @llvm.noalias.decl.p0i8.p0a1s_struct.window_internals.i32([1 x %struct.window_internal]* %window_buf0_buf0d, i32 0, metadata !162), !dbg !160, !noalias !151
  store i8* undef, i8** %buf0_ptr, align 4, !dbg !163, !noalias !151
  %2 = bitcast i8** %buf0_ptr to i8*, !dbg !163
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #5, !dbg !163, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf0_ptr, metadata !141, metadata !DIExpression()), !dbg !164
  store i8* bitcast ([384 x %struct.v8int16]* @buf0 to i8*), i8** %buf0_ptr, align 4, !dbg !164, !tbaa !165, !noalias !151
  store i8* undef, i8** %buf0d_ptr, align 4, !dbg !167, !noalias !151
  %3 = bitcast i8** %buf0d_ptr to i8*, !dbg !167
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %3) #5, !dbg !167, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf0d_ptr, metadata !142, metadata !DIExpression()), !dbg !168
  store i8* bitcast ([384 x %struct.v8int16]* @buf0d to i8*), i8** %buf0d_ptr, align 4, !dbg !168, !tbaa !165, !noalias !151
  %arraydecay = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf0_buf0d, i32 0, i32 0, !dbg !169
  call addrspace(1) void @_ZL11window_initP15window_internaliP7v8int16jS2_jii(%struct.window_internal* %arraydecay, i32 1, %struct.v8int16* getelementptr inbounds ([384 x %struct.v8int16], [384 x %struct.v8int16]* @buf0, i32 0, i32 0), i32 32, %struct.v8int16* getelementptr inbounds ([384 x %struct.v8int16], [384 x %struct.v8int16]* @buf0d, i32 0, i32 0), i32 33, i32 384, i32 384) #16, !dbg !170, !noalias !151
  store [1 x %struct.window_internal] undef, [1 x %struct.window_internal]* %window_buf1_buf1d, align 4, !dbg !171, !noalias !151
  %4 = bitcast [1 x %struct.window_internal]* %window_buf1_buf1d to i8*, !dbg !171
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 52, i8* %4) #5, !dbg !171, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata [1 x %struct.window_internal]* %window_buf1_buf1d, metadata !143, metadata !DIExpression()), !dbg !172
  %5 = call addrspace(1) i8* @llvm.noalias.decl.p0i8.p0a1s_struct.window_internals.i32([1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, metadata !173), !dbg !171, !noalias !151
  store i8* undef, i8** %buf1_ptr, align 4, !dbg !174, !noalias !151
  %6 = bitcast i8** %buf1_ptr to i8*, !dbg !174
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %6) #5, !dbg !174, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf1_ptr, metadata !144, metadata !DIExpression()), !dbg !175
  store i8* bitcast ([384 x %struct.v8int16]* @buf1 to i8*), i8** %buf1_ptr, align 4, !dbg !175, !tbaa !165, !noalias !151
  store i8* undef, i8** %buf1d_ptr, align 4, !dbg !176, !noalias !151
  %7 = bitcast i8** %buf1d_ptr to i8*, !dbg !176
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %7) #5, !dbg !176, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf1d_ptr, metadata !145, metadata !DIExpression()), !dbg !177
  store i8* bitcast ([384 x %struct.v8int16]* @buf1d to i8*), i8** %buf1d_ptr, align 4, !dbg !177, !tbaa !165, !noalias !151
  %arraydecay1 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !178
...
while.body:                                       ; preds = %while.cond
  store i32 undef, i32* %proc_24_0_bounds, align 4, !dbg !183, !noalias !151
  %9 = bitcast i32* %proc_24_0_bounds to i8*, !dbg !183
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %9) #5, !dbg !183, !noalias !151
  call addrspace(1) void @llvm.dbg.declare(metadata i32* %proc_24_0_bounds, metadata !149, metadata !DIExpression()), !dbg !184
  ...
  store i32 %10, i32* %proc_24_0_bounds, align 4, !dbg !184, !tbaa !156, !noalias !151
  br label %while.cond2, !dbg !186

while.cond2:                                      ; preds = %if.end, %while.body
  %11 = load i32, i32* %proc_24_0_bounds, align 4, !dbg !187, !tbaa !156, !noalias !151
  %tobool = icmp ne i32 %11, 0, !dbg !187
  br i1 %tobool, label %while.body3, label %while.end, !dbg !186

while.body3:                                      ; preds = %while.cond2
  %arraydecay4 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf0_buf0d, i32 0, i32 0, !dbg !188
  %12 = load i8*, i8** %buf0_ptr, align 4, !dbg !190, !tbaa !165, !noalias !151
  %13 = load i8*, i8** %buf0d_ptr, align 4, !dbg !191, !tbaa !165, !noalias !151
  %14 = load i32, i32* %index, align 4, !dbg !192, !tbaa !156, !noalias !151
  call addrspace(1) void @_ZL14window_acquireP15window_internaljjPaS1_iii(%struct.window_internal* %arraydecay4, i32 32, i32 33, i8* %12, i8* %13, i32 0, i32 %14, i32 1) #16, !dbg !193, !noalias !151
  %arraydecay5 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !194
  %15 = load i8*, i8** %buf1_ptr, align 4, !dbg !195, !tbaa !165, !noalias !151
  %16 = load i8*, i8** %buf1d_ptr, align 4, !dbg !196, !tbaa !165, !noalias !151
  ...
  %arraydecay6 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf0_buf0d, i32 0, i32 0, !dbg !199
  ...
  %arraydecay7 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !201
  ...
  call addrspace(1) void @_Z10n2n_trans1P12input_windowIsEP13output_windowIsE(%struct.input_window.0* %call, %struct.output_window.1* %call8) #16, !dbg !203, !noalias !151
  %arraydecay9 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf0_buf0d, i32 0, i32 0, !dbg !204
  %18 = load i8*, i8** %buf0_ptr, align 4, !dbg !205, !tbaa !165, !noalias !151
  %19 = load i8*, i8** %buf0d_ptr, align 4, !dbg !206, !tbaa !165, !noalias !151
  %20 = load i32, i32* %index, align 4, !dbg !207, !tbaa !156, !noalias !151
  call addrspace(1) void @_ZL14window_releaseP15window_internaljjPaS1_iii(%struct.window_internal* %arraydecay9, i32 32, i32 33, i8* %18, i8* %19, i32 0, i32 %20, i32 0) #16, !dbg !208, !noalias !151
  %arraydecay10 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !209
  %21 = load i8*, i8** %buf1_ptr, align 4, !dbg !210, !tbaa !165, !noalias !151
  %22 = load i8*, i8** %buf1d_ptr, align 4, !dbg !211, !tbaa !165, !noalias !151
  ...
  %25 = load i32, i32* %proc_24_0_bounds, align 4, !dbg !218, !tbaa !156, !noalias !151
  %cmp = icmp sgt i32 %25, 0, !dbg !220
  br i1 %cmp, label %if.then, label %if.end, !dbg !221

if.then:                                          ; preds = %while.body3
  %26 = load i32, i32* %proc_24_0_bounds, align 4, !dbg !222, !tbaa !156, !noalias !151
  %dec = add nsw i32 %26, -1, !dbg !222
  store i32 %dec, i32* %proc_24_0_bounds, align 4, !dbg !222, !tbaa !156, !noalias !151
...
cleanup:                                          ; preds = %if.end13, %if.then12
  %28 = bitcast i32* %proc_24_0_bounds to i8*, !dbg !231
...
; Function Attrs: nounwind
define dso_local void @_Z10n2n_trans1P12input_windowIsEP13output_windowIsE(%struct.input_window.0* %matA, %struct.output_window.1* %matB) addrspace(1) #14 !dbg !567 {
entry:
  %matA.addr = alloca %struct.input_window.0*, align 4
  %matB.addr = alloca %struct.output_window.1*, align 4
  %i = alloca i32, align 4
  %A = alloca i16, align 2
  store %struct.input_window.0* %matA, %struct.input_window.0** %matA.addr, align 4, !tbaa !165
  call addrspace(1) void @llvm.dbg.declare(metadata %struct.input_window.0** %matA.addr, metadata !572, metadata !DIExpression()), !dbg !579
  store %struct.output_window.1* %matB, %struct.output_window.1** %matB.addr, align 4, !tbaa !165
  call addrspace(1) void @llvm.dbg.declare(metadata %struct.output_window.1** %matB.addr, metadata !573, metadata !DIExpression()), !dbg !580
...
for.body:                                         ; preds = %for.cond
  store i16 undef, i16* %A, align 2, !dbg !587
  %3 = bitcast i16* %A to i8*, !dbg !587
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #5, !dbg !587
  call addrspace(1) void @llvm.dbg.declare(metadata i16* %A, metadata !576, metadata !DIExpression()), !dbg !588
  %4 = load %struct.input_window.0*, %struct.input_window.0** %matA.addr, align 4, !dbg !589, !tbaa !165
  ...
  store i16 %call, i16* %A, align 2, !dbg !588, !tbaa !591
  %5 = load %struct.output_window.1*, %struct.output_window.1** %matB.addr, align 4, !dbg !593, !tbaa !165
  %6 = load i16, i16* %A, align 2, !dbg !594, !tbaa !591
...
!125 = !DILocalVariable(name: "window_buf0_buf0d", scope: !121, file: !58, line: 34, type: !126)
...
!141 = !DILocalVariable(name: "buf0_ptr", scope: !121, file: !58, line: 35, type: !11)
!142 = !DILocalVariable(name: "buf0d_ptr", scope: !121, file: !58, line: 36, type: !11)
!143 = !DILocalVariable(name: "window_buf1_buf1d", scope: !121, file: !58, line: 38, type: !126)
!144 = !DILocalVariable(name: "buf1_ptr", scope: !121, file: !58, line: 39, type: !11)
!145 = !DILocalVariable(name: "buf1d_ptr", scope: !121, file: !58, line: 40, type: !11)
...
!149 = !DILocalVariable(name: "proc_24_0_bounds", scope: !150, file: !58, line: 46, type: !147)
!150 = distinct !DILexicalBlock(scope: !121, file: !58, line: 44, column: 3)
!151 = !{!152, !154}
!152 = distinct !{!152, !153, !"main: window_buf0_buf0d"}
!153 = distinct !{!153, !"main"}
!154 = distinct !{!154, !153, !"main: window_buf1_buf1d"}
...
!195 = !DILocation(line: 53, column: 66, scope: !189)
!196 = !DILocation(line: 53, column: 75, scope: !189)
!197 = !DILocation(line: 53, column: 87, scope: !189)
...
!210 = !DILocation(line: 59, column: 66, scope: !189)
!211 = !DILocation(line: 59, column: 75, scope: !189)
!212 = !DILocation(line: 59, column: 87, scope: !189)
...
!567 = distinct !DISubprogram(name: "n2n_trans1", linkageName: "_Z10n2n_trans1P12input_windowIsEP13output_windowIsE", scope: !568, file: !568, line: 5, type: !569, scopeLine: 6, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !75, retainedNodes: !571)
!568 = !DIFile(filename: "aie/n2n_trans1.cc", directory: "/home/Jinming/research/aie_project/n2n")
!569 = !DISubroutineType(types: !570)
!570 = !{null, !18, !41}
!571 = !{!572, !573, !574, !576}
!572 = !DILocalVariable(name: "matA", arg: 1, scope: !567, file: !568, line: 5, type: !18)
!573 = !DILocalVariable(name: "matB", arg: 2, scope: !567, file: !568, line: 6, type: !41)
...
!576 = !DILocalVariable(name: "A", scope: !577, file: !568, line: 9, type: !94)
...
!601 = !DILocation(line: 12, column: 1, scope: !567)
