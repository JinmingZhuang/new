; ModuleID = '/home/Jinming/research/aie_project/n2n/Work/aie/25_0/src/25_0.cc'
...
entry:
  ...
  store [1 x %struct.window_internal] undef, [1 x %struct.window_internal]* %window_buf1_buf1d, align 4, !dbg !188, !noalias !179
  %0 = bitcast [1 x %struct.window_internal]* %window_buf1_buf1d to i8*, !dbg !188
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 52, i8* %0) #5, !dbg !188, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata [1 x %struct.window_internal]* %window_buf1_buf1d, metadata !153, metadata !DIExpression()), !dbg !189
  %1 = call addrspace(1) i8* @llvm.noalias.decl.p0i8.p0a1s_struct.window_internals.i32([1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, metadata !190), !dbg !188, !noalias !179
  store i8* undef, i8** %buf1_ptr, align 4, !dbg !191, !noalias !179
  %2 = bitcast i8** %buf1_ptr to i8*, !dbg !191
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #5, !dbg !191, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf1_ptr, metadata !169, metadata !DIExpression()), !dbg !192
  store i8* bitcast ([384 x %struct.v8int16]* @buf1 to i8*), i8** %buf1_ptr, align 4, !dbg !192, !tbaa !193, !noalias !179
  store i8* undef, i8** %buf1d_ptr, align 4, !dbg !195, !noalias !179
  %3 = bitcast i8** %buf1d_ptr to i8*, !dbg !195
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %3) #5, !dbg !195, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf1d_ptr, metadata !170, metadata !DIExpression()), !dbg !196
  store i8* bitcast ([384 x %struct.v8int16]* @buf1d to i8*), i8** %buf1d_ptr, align 4, !dbg !196, !tbaa !193, !noalias !179
  %arraydecay = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !197
  call addrspace(1) void @_ZL11window_initP15window_internaliP7v8int16jS2_jii(%struct.window_internal* %arraydecay, i32 1, %struct.v8int16* getelementptr inbounds ([384 x %struct.v8int16], [384 x %struct.v8int16]* @buf1, i32 0, i32 0), i32 16, %struct.v8int16* getelementptr inbounds ([384 x %struct.v8int16], [384 x %struct.v8int16]* @buf1d, i32 0, i32 0), i32 17, i32 384, i32 384) #16, !dbg !198, !noalias !179
  store [1 x %struct.window_internal] undef, [1 x %struct.window_internal]* %window_buf2_buf2d, align 4, !dbg !199, !noalias !179
  %4 = bitcast [1 x %struct.window_internal]* %window_buf2_buf2d to i8*, !dbg !199
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 52, i8* %4) #5, !dbg !199, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata [1 x %struct.window_internal]* %window_buf2_buf2d, metadata !171, metadata !DIExpression()), !dbg !200
  %5 = call addrspace(1) i8* @llvm.noalias.decl.p0i8.p0a1s_struct.window_internals.i32([1 x %struct.window_internal]* %window_buf2_buf2d, i32 0, metadata !201), !dbg !199, !noalias !179
  store i8* undef, i8** %buf2_ptr, align 4, !dbg !202, !noalias !179
  %6 = bitcast i8** %buf2_ptr to i8*, !dbg !202
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %6) #5, !dbg !202, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf2_ptr, metadata !172, metadata !DIExpression()), !dbg !203
  store i8* bitcast ([384 x %struct.v8int16]* @buf2 to i8*), i8** %buf2_ptr, align 4, !dbg !203, !tbaa !193, !noalias !179
  store i8* undef, i8** %buf2d_ptr, align 4, !dbg !204, !noalias !179
  %7 = bitcast i8** %buf2d_ptr to i8*, !dbg !204
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %7) #5, !dbg !204, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata i8** %buf2d_ptr, metadata !173, metadata !DIExpression()), !dbg !205
  store i8* bitcast ([384 x %struct.v8int16]* @buf2d to i8*), i8** %buf2d_ptr, align 4, !dbg !205, !tbaa !193, !noalias !179
  %arraydecay1 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf2_buf2d, i32 0, i32 0, !dbg !206
...
while.body:                                       ; preds = %while.cond
  store i32 undef, i32* %proc_25_0_bounds, align 4, !dbg !211, !noalias !179
  %9 = bitcast i32* %proc_25_0_bounds to i8*, !dbg !211
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 4, i8* %9) #5, !dbg !211, !noalias !179
  call addrspace(1) void @llvm.dbg.declare(metadata i32* %proc_25_0_bounds, metadata !177, metadata !DIExpression()), !dbg !212
  ...
  store i32 %10, i32* %proc_25_0_bounds, align 4, !dbg !212, !tbaa !184, !noalias !179
  br label %while.cond2, !dbg !214

while.cond2:                                      ; preds = %if.end, %while.body
  %11 = load i32, i32* %proc_25_0_bounds, align 4, !dbg !215, !tbaa !184, !noalias !179
  %tobool = icmp ne i32 %11, 0, !dbg !215
  br i1 %tobool, label %while.body3, label %while.end, !dbg !214

while.body3:                                      ; preds = %while.cond2
  %arraydecay4 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !216
  %12 = load i8*, i8** %buf1_ptr, align 4, !dbg !218, !tbaa !193, !noalias !179
  %13 = load i8*, i8** %buf1d_ptr, align 4, !dbg !219, !tbaa !193, !noalias !179
  %14 = load i32, i32* %index, align 4, !dbg !220, !tbaa !184, !noalias !179
  call addrspace(1) void @_ZL14window_acquireP15window_internaljjPaS1_iii(%struct.window_internal* %arraydecay4, i32 16, i32 17, i8* %12, i8* %13, i32 0, i32 %14, i32 1) #16, !dbg !221, !noalias !179
  %arraydecay5 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf2_buf2d, i32 0, i32 0, !dbg !222
  %15 = load i8*, i8** %buf2_ptr, align 4, !dbg !223, !tbaa !193, !noalias !179
  %16 = load i8*, i8** %buf2d_ptr, align 4, !dbg !224, !tbaa !193, !noalias !179
  ...
  %arraydecay6 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !227
  ...
  %arraydecay7 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf2_buf2d, i32 0, i32 0, !dbg !229
  ...
  call addrspace(1) void @_Z10n2n_trans2P12input_windowIsEP13output_windowIsE(%struct.input_window.0* %call, %struct.output_window.1* %call8) #16, !dbg !231, !noalias !179
  %arraydecay9 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf1_buf1d, i32 0, i32 0, !dbg !232
  %18 = load i8*, i8** %buf1_ptr, align 4, !dbg !233, !tbaa !193, !noalias !179
  %19 = load i8*, i8** %buf1d_ptr, align 4, !dbg !234, !tbaa !193, !noalias !179
  %20 = load i32, i32* %index, align 4, !dbg !235, !tbaa !184, !noalias !179
  call addrspace(1) void @_ZL14window_releaseP15window_internaljjPaS1_iii(%struct.window_internal* %arraydecay9, i32 16, i32 17, i8* %18, i8* %19, i32 0, i32 %20, i32 0) #16, !dbg !236, !noalias !179
  %arraydecay10 = getelementptr inbounds [1 x %struct.window_internal], [1 x %struct.window_internal]* %window_buf2_buf2d, i32 0, i32 0, !dbg !237
  %21 = load i8*, i8** %buf2_ptr, align 4, !dbg !238, !tbaa !193, !noalias !179
  %22 = load i8*, i8** %buf2d_ptr, align 4, !dbg !239, !tbaa !193, !noalias !179
  ...
  %25 = load i32, i32* %proc_25_0_bounds, align 4, !dbg !246, !tbaa !184, !noalias !179
  %cmp = icmp sgt i32 %25, 0, !dbg !248
  br i1 %cmp, label %if.then, label %if.end, !dbg !249

if.then:                                          ; preds = %while.body3
  %26 = load i32, i32* %proc_25_0_bounds, align 4, !dbg !250, !tbaa !184, !noalias !179
  %dec = add nsw i32 %26, -1, !dbg !250
  store i32 %dec, i32* %proc_25_0_bounds, align 4, !dbg !250, !tbaa !184, !noalias !179
...
cleanup:                                          ; preds = %if.end13, %if.then12
  %28 = bitcast i32* %proc_25_0_bounds to i8*, !dbg !259
...
; Function Attrs: nounwind
define dso_local void @_Z10n2n_trans2P12input_windowIsEP13output_windowIsE(%struct.input_window.0* %matB, %struct.output_window.1* %matC) addrspace(1) #14 !dbg !595 {
entry:
  %matB.addr = alloca %struct.input_window.0*, align 4
  %matC.addr = alloca %struct.output_window.1*, align 4
  %i = alloca i32, align 4
  %B = alloca i16, align 2
  store %struct.input_window.0* %matB, %struct.input_window.0** %matB.addr, align 4, !tbaa !193
  call addrspace(1) void @llvm.dbg.declare(metadata %struct.input_window.0** %matB.addr, metadata !600, metadata !DIExpression()), !dbg !607
  store %struct.output_window.1* %matC, %struct.output_window.1** %matC.addr, align 4, !tbaa !193
  call addrspace(1) void @llvm.dbg.declare(metadata %struct.output_window.1** %matC.addr, metadata !601, metadata !DIExpression()), !dbg !608
...
for.body:                                         ; preds = %for.cond
  store i16 undef, i16* %B, align 2, !dbg !615
  %3 = bitcast i16* %B to i8*, !dbg !615
  call addrspace(1) void @llvm.lifetime.start.p0i8(i64 2, i8* %3) #5, !dbg !615
  call addrspace(1) void @llvm.dbg.declare(metadata i16* %B, metadata !604, metadata !DIExpression()), !dbg !616
  %4 = load %struct.input_window.0*, %struct.input_window.0** %matB.addr, align 4, !dbg !617, !tbaa !193
  ...
  store i16 %call, i16* %B, align 2, !dbg !616, !tbaa !619
  %5 = load %struct.output_window.1*, %struct.output_window.1** %matC.addr, align 4, !dbg !621, !tbaa !193
  %6 = load i16, i16* %B, align 2, !dbg !622, !tbaa !619
...
!153 = !DILocalVariable(name: "window_buf1_buf1d", scope: !149, file: !58, line: 34, type: !154)
...
!169 = !DILocalVariable(name: "buf1_ptr", scope: !149, file: !58, line: 35, type: !11)
!170 = !DILocalVariable(name: "buf1d_ptr", scope: !149, file: !58, line: 36, type: !11)
!171 = !DILocalVariable(name: "window_buf2_buf2d", scope: !149, file: !58, line: 38, type: !154)
!172 = !DILocalVariable(name: "buf2_ptr", scope: !149, file: !58, line: 39, type: !11)
!173 = !DILocalVariable(name: "buf2d_ptr", scope: !149, file: !58, line: 40, type: !11)
...
!177 = !DILocalVariable(name: "proc_25_0_bounds", scope: !178, file: !58, line: 46, type: !175)
!178 = distinct !DILexicalBlock(scope: !149, file: !58, line: 44, column: 3)
!179 = !{!180, !182}
!180 = distinct !{!180, !181, !"main: window_buf1_buf1d"}
!181 = distinct !{!181, !"main"}
!182 = distinct !{!182, !181, !"main: window_buf2_buf2d"}
...
!223 = !DILocation(line: 53, column: 69, scope: !217)
!224 = !DILocation(line: 53, column: 78, scope: !217)
!225 = !DILocation(line: 53, column: 90, scope: !217)
...
!238 = !DILocation(line: 59, column: 69, scope: !217)
!239 = !DILocation(line: 59, column: 78, scope: !217)
!240 = !DILocation(line: 59, column: 90, scope: !217)
...
!595 = distinct !DISubprogram(name: "n2n_trans2", linkageName: "_Z10n2n_trans2P12input_windowIsEP13output_windowIsE", scope: !596, file: !596, line: 5, type: !597, scopeLine: 6, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !75, retainedNodes: !599)
!596 = !DIFile(filename: "aie/n2n_trans2.cc", directory: "/home/Jinming/research/aie_project/n2n")
!597 = !DISubroutineType(types: !598)
!598 = !{null, !93, !128}
!599 = !{!600, !601, !602, !604}
!600 = !DILocalVariable(name: "matB", arg: 1, scope: !595, file: !596, line: 5, type: !93)
!601 = !DILocalVariable(name: "matC", arg: 2, scope: !595, file: !596, line: 6, type: !128)
...
!604 = !DILocalVariable(name: "B", scope: !605, file: !596, line: 9, type: !108)
...
!629 = !DILocation(line: 13, column: 1, scope: !595)
